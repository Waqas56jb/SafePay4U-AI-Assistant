/**
 * SafePay4U Voice Agent — GPT-4o Realtime via WebRTC + ephemeral token.
...
export function VoiceAgent({ onClose }) {
  ...
  const subtitle = isSpeaking ? 'SafePay4U AI is speaking…' : isErr ? '' : 'Speak naturally — I\'m listening';
